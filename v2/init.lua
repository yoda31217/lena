...
-- Best font is:
-- Input Font Densed from:
-- https://input.djr.com/
-- by echasnovski comment:
-- https://www.reddit.com/r/neovim/comments/189nw6r/comment/kbyfqpu/
...
vim.keymap.set(
  ...
  "<leader>p",
  '"_dp',
  { desc = "[P]aste into selected w/o copy" }
)
...
require("lazy").setup({
      ...
      vim.keymap.set("n", "<leader><leader>", function()
        ...
        builtin.buffers({
          ...
          entry_maker = function(entry)
            local filename = entry.info.name ~= "" and entry.info.name
              or "[No Name]"
  ...
  -- NeoTree setup from Kickstart documantation:
  -- https://github.com/nvim-lua/kickstart.nvim?tab=readme-ov-file#examples-of-adding-popularly-requested-plugins
  {
